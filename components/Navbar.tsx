...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex flex-col items-center p-4 md:p-6 pointer-events-none">
      ...
      {/* Mobile Menu Overlay */}
      <div className={`pointer-events-auto absolute top-full left-0 right-0 px-4 pt-2 transition-all duration-300 transform origin-top md:hidden ${isMobileMenuOpen ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-4 pointer-events-none'}`}>
