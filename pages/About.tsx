...
const team: TeamMember[] = [
  {
    ...
    linkedin: "linkedin.com/in/muhammad-haseeb-739884317"
  },
  {
                  ...
                  <div className="px-3 pb-4">
                    ...
                    {member.linkedin && (
                      <a
                        ...
                        className="inline-flex items-center gap-2 text-white/40 hover:text-[#0077b5] transition-colors group/link"
                      >
                        <svg className="w-5 h-5 transition-transform group-hover/link:-translate-y-1" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
                        </svg>
                        <span className="text-xs font-medium opacity-0 group-hover/link:opacity-100 transition-opacity -translate-x-2 group-hover/link:translate-x-0">Connect</span>
                      </a>
                    )}
                  </div>
                </div>
